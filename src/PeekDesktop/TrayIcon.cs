...
internal sealed class TrayIcon : IDisposable
{
    ...
    private void ShowContextMenu()
    {
        ...
        menu.AddItem(ID_DESKTOP_CLICK, "点击桌面时显示桌面", ToggleDesktopClick, _settings.PeekOnDesktopClick);
        menu.AddItem(ID_TASKBAR_CLICK, "点击任务栏时显示桌面", ToggleTaskbarClick, _settings.PeekOnTaskbarClick);
        ...
        menu.AddItem(ID_AUTO_UPDATES, "自动检查更新", ToggleAutoUpdates, _settings.AutoCheckForUpdates);
        menu.AddSeparator();
